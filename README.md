...
Maker Mark (Marcus Lembo) — Pasco–Pinellas housing hunt plus Tampa Bay licensed mobile home parks.
...
- Home Hunt (Tampa Bay): https://mjlembo88.github.io/Real-Estate/home-hunt/

Do not invent listings, rents, lot counts, or pet rules. Numbers are sourced as of late Aug 2026.

## Local

Open `index.html` or `atlas/index.html` in a browser. Notes and Hard NOs save in localStorage.
